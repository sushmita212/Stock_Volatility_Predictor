...
<br>
The goal of this project is to learn and implement time series analysis to predict volatility of log returns using historical open, high, low, close, volume (OHLCV) data. We use historical daily stock data from Alpha Vantage API.
